...
project = 'iglsynth'
copyright = '2019, Abhishek N. Kulkarni'
...
latex_documents = [
    (master_doc, 'iglsynth.tex', 'iglsynth Documentation',
...
man_pages = [
    (master_doc, 'iglsynth', 'iglsynth Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'iglsynth', 'iglsynth Documentation',
     author, 'iglsynth', 'One line description of project.',
     'Miscellaneous'),
]
